...
cdo selmon,1,2,3,12 -del29feb ${dat}.nc ${dat}.N_${seas}.nc #sep
cdo sellonlatbox,0,360,30,90 ${dat}.N_${seas}.nc ${dat}.Nor_${seas}.nc

#für mai und oktober 
cdo selmon,1,2,3,4,11,12 -del29feb ${dat}.nc ${dat}.N_${seas}_ext.nc #mit okt #ext
...
cdo copy mon.01.nc mon.02.nc mon.03.nc mon.04.nc mon.11.nc mon.12.nc ydaymean.nc #ext
rm mon.??.nc
...
cdo copy rm21.01.nc rm21.02.nc rm21.03.nc rm21.12.nc aacrm21.nc #rm21.09.nc #normal

cdo sub -selmon,1,2,3,12 ${dat}.N_${seas}_ext_tr.nc aacrm21.nc ${dat}.N_${seas}_atrbg_aacrm21.nc #tr #normal
